    ...
    const fetchData = async () => {
      try {
        ...
        const newBalanceBankInfoData = [
          ...
          {
            label: "총 출금가능액",
            amount: result.bankWithdrawableAmount.toLocaleString() + "원",
          },
        ];
        ...
        const newBalanceSecInfoData = [
          {
            label: "총 잔액",
            amount: result.securitiesTotalAmount.toLocaleString() + "원",
          },
          {
            label: "총 출금가능액",
            amount:
              result.securitiesTotalPurchaseAmount.toLocaleString() + "원",
          },
        ];
        ...
        const newBalanceHouseInfoData = [
          {
            label: "총 가치",
            amount: result.housingTotalAmount.toLocaleString() + "원",
          },
        ];
        ...
        <StyledHomeContent style={{ overflow: "hidden", padding: "40px" }}>
          ...
          >
            <StyledHeadText>
              ...
              >
                ※ 자산 정보를 보내지 않을 경우, PB는 내 자산에 대한 정보를
                확인할 수 없습니다.
              </p>
            </StyledHeadText>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              <Button id="mydata-api" onClick={onClickMydataButton}>
                다음으로
              </Button>
            </div>
          </div>
