...
export default function Request() {
    ...
    const investImpOptions = [
        '손해를 줄이는 것',
        '수익을 늘리는 것',
        '둘 사이 어딘가',
    ];
    const investLossOptions = [
        '전부 판다',
        '일부를 판다',
        '그대로 보유할 것이다',
        '오히려 더 투자한다',
                ...
                <StyledHomeContent style={{ overflow: 'auto' }}>
                    <StyledPbSection style={{ margin: '20px' }}>
                        {showForm ? (
                            <>
                                <StyledHeadText>
                                    예약이 확정되면, {userName.slice(1)}님만을
                                    위한 상담이 준비됩니다.
                                    <br />
                                    {userName.slice(1)}님의 투자 성향을 함께
                                    보내주세요.
                                </StyledHeadText>
                        ...
                        showNewContent ? (
                            <>
                                ...
                                >
                                    <Modal.Header id="modal-header">
                                        <img
                                            src="/assets/reserve-complete.svg"
                                            width={'90px'}
                                        ></img>
                                    ...
                                    >
                                        <b>{selectedPb.username}PB</b>에게 상담
                                        요청을 보냈습니다.
                                        <br />
                                        <br />
                                        예약날짜: {formatDate(selectedDate)}
                                        <br />
