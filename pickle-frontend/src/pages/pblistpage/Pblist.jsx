...
export default function Pblist() {
    ...
    const filteredData = pbData.filter((pb) => {
        const mainFieldMatch =
            ...
            selectedMainFields.every((field) => pb.mainFields.includes(field));
        const tagMatch =
            selectedTags.length === 0 ||
            selectedTags.every((tag) => pb.tags.includes(tag));
    ...
    const sixMonthLater = new Date(
        new Date().setDate(new Date().getDate() + 189)
    );
                                ...
                                <div className="filtering">
                                    ...
                                    >
                                        <StyledFilterImg>
                                            <img
                                                ...
                                                src="/assets/filter-mainsector.svg"
                                            ></img>
                                            <DropdownButton
                                                id="custom-dropdown"
                                                title="주력 분야"
                                            ...
                                            >
                                                <Dropdown.Item eventKey="국내주식">
                                                    국내주식
                                                </Dropdown.Item>
                                                <Dropdown.Item eventKey="해외주식">
                                                    해외주식
                                                </Dropdown.Item>
                                                <Dropdown.Item eventKey="채권">
                                                    채권
                                                </Dropdown.Item>
                                            </DropdownButton>
                                        </StyledFilterImg>
                                    ...
                                    >
                                        <StyledFilterImg>
                                            ...
                                            >
                                                <Dropdown.Item eventKey="연금">
                                                    연금
                                                </Dropdown.Item>
                                                <Dropdown.Item eventKey="노후자금">
                                                    노후자금
                                                </Dropdown.Item>
                                                <Dropdown.Item eventKey="ETF">
                                                    ETF
                                                </Dropdown.Item>
                                                <Dropdown.Item eventKey="중개형 ISA">
                                                    중개형 ISA
                                                </Dropdown.Item>
                                                <Dropdown.Item eventKey="결혼자금 설계">
                                                    결혼자금 설계
                                                </Dropdown.Item>
                                            </DropdownButton>
                                        </StyledFilterImg>
                                    ...
                                    >
                                        <StyledPbCard>
                                            {selectedPb.img && (
                                                <img
                                                    src={selectedPb.img}
                                                    alt={`${selectedPb.username} 이미지`}
                                                />
                                            )}
                                            <section className="self-introduce">
                                                <div id="name">
                                                    {selectedPb.username}PB
                                                </div>
                                                <div id="location">
                                                    <img
                                                        src="/assets/pb-location.svg"
                                                        alt="location"
                                                    />
                                                    {selectedPb.branchOffice}
                                                </div>
                                                <div id="introduction">
                                                    {selectedPb.introduction}
                                                </div>
                                            </section>
                                            <section className="sector">
                                                <article className="mainfield">
                                                    <p>주력 분야</p>
                                                    {selectedPb.mainFields.map(
                                                        (field, i) => (
                                                            <div
                                                                id="mainfields"
                                                                key={i}
                                                ...
                                                <article className="ports">
                                                    ...
                                                    <div id="price">
                                                        {
                                                            selectedPb.minConsultingAmount
                                                        }
                                                        만원 이상
                                                    </div>
                                                </article>
