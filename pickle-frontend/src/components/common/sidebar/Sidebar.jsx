            ...
            <StyledSideDiv>
                <StyledSideContent>
                    ...
                    <StyledSideTextGroup>
                        ...
                        <Link to="/mystrategy" style={{ textDecoration: 'none' }}>
                            <StyledSideText style={{ fontSize: "small", marginLeft: "30px" }}>
                                전략 관리
                            </StyledSideText>
                        </Link>
                    </StyledSideTextGroup>
                    <StyledSideTextGroup>
                        <Link to="/pblist" style={{ textDecoration: 'none' }}>
                            <StyledSideText>
                                <img src="/assets/side-pb.svg" className="icon" alt="PB 둘러보기 아이콘" />
                                <span>PB 둘러보기</span>
                            </StyledSideText>
                        </Link>
                        <Link to="/myrequest" style={{ textDecoration: 'none' }}>
                            <StyledSideText style={{ fontSize: "small", marginLeft: "30px" }}>
                                요청 목록
                            </StyledSideText>
                        </Link>
